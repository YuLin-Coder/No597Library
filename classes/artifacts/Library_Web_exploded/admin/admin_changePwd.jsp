		...
		<div class="row " style="margin-top: 50px;">
			<div align="center" class="col-md-3">
				<ul class="list-group">
					...
					<li class="list-group-item active"><a href="admin_changePwd.jsp"><span
			...
			<div class=" col-md-9 " align="center">
				<form action="../ChangeAdminPwd" method="post">
					<table style="margin-left: 50px;margin-top: 100px;" >
						<tr>
							<td align="right"><b>原密码<b></td>
							<td style="padding-left: 20px"><input style="margin-left: 50px;margin-top: 10px;"
								type="password" class="form-control inputclass" name="oldpwd"></td>
						</tr>
						<tr>
							<td align="right"><b>新密码:<b></td>
							<td style="padding-left: 20px"><input type="password" style="margin-left: 50px;margin-top: 10px;"
								class="form-control inputclass" name="newPwd1"></td>

						</tr>
						<tr>
							<td align="right"><b>确认密码:<b></td>
							<td style="padding-left: 20px"><input type="password" style="margin-left: 50px;margin-top: 10px;"
								class="form-control inputclass" name="newPwd2"></td>

						</tr>

						<tr>
							<td></td>
							<td style="padding-left: 20px;padding-top:50px;"><button class="btn btn-info"
