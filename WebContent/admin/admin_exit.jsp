		...
		<div class="row " style="margin-top: 50px;">
			<div align="center" class="col-md-3">
				<ul class="list-group">
					...
					<li class="list-group-item"><a
						href="admin_changePwd.jsp"><span style="color: black">修改密码</span></a></li>
					<li class="list-group-item"><a href="admin_register.jsp"><span
							style="color: black">添加管理员</span></a></li>
					<li class="list-group-item active"><span style="color: black">退出</span></li>
				</ul>
			</div>
			<div class="col-md-9" align="center" style="border: 1px solid black;">
				...
				<div align="center" style="padding-top: 80px; width: 250px;"
					class=" row">
					<a href="../Exit?type=admin" class="btn btn-danger "
						style="width: 80px; margin-right: 75px;"> 退出</a>
					<a  href="admin_about.jsp"><button class="btn btn-info " style="width:80px" > 取消</button></a>
				</div>
			</div>
		</div>
	</div>
